...
public class ReceivedOrdersFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_da_nhan, container, false);
    ...
    void initButton(View view) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getContext(), UpdateDHActivity.class);
    ...
    public List<Item> getListItemChecked(){
        List<Item> mListRespone = new ArrayList<>();
        for (int i = 0; i< mListItem.size();i++)
            if(mListItem.get(i).isCheck())
                mListRespone.add(mListItem.get(i));
    ...
    public void setupRecyclerView() {
        ...
        adpater = new RecyclerViewAdapter(getContext(), mListItem, this,true);
